 ...
 * class defines any members, you need to separate the enum constant definitions from the member
 * definitions with a semicolon, just like in Java.
 */

/**
 * Working with Enum Constants
 * Just like in Java, enum classes in Kotlin have synthetic methods allowing to list the defined
 * enum constants and to get an enum constant by its name. The signatures of these methods are as
